...
--
-- Host: localhost
-- Generation Time: Aug 10, 2022 at 01:07 PM
...
--
-- Database: `electricity_theft_detection`
--
CREATE DATABASE IF NOT EXISTS `electricity_theft_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `electricity_theft_detection`;
...
('et5nw4pf8jmw4fohb7cna4piom9q7q5k', 'eyJ1c2VyaWQiOjF9:1oLkOd:CUut1HMCE_6JBDgNoQIAPugTC34fmiBzI4o1KEmRh0E', '2022-08-24 12:01:11.648587'),
...
('ydupc45x151qvpw3r9dfs4lqmlznj2td', 'eyJ1c2VyaWQiOjN9:1oLlMJ:ZQSOV0WBuY5UBzsl9dRq-Aot5fS1TwPgesoVkNeXmGg', '2022-08-24 13:02:51.222996'),
...
(1, 'Krishna', 'Krishna123@gmail.com', 'Krishna', '9535866270', 'India', 'Karnataka', 'Bangalore'),
...
(35, 'SVM', '56.48093841642229'),
(36, 'Logistic Regression', '56.48093841642229'),
(37, 'Decision Tree Classifier', '43.55816226783969');
...
--
-- Table structure for table `remote_user_theft_detection_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_theft_detection_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `LCLid` varchar(300) NOT NULL,
  `Age` varchar(300) NOT NULL,
  `Sex` varchar(300) NOT NULL,
  `day` varchar(300) NOT NULL,
  `energy_median` varchar(300) NOT NULL,
  `energy_mean` varchar(300) NOT NULL,
  `energy_max` varchar(300) NOT NULL,
  `energy_count` varchar(300) NOT NULL,
  `energy_std` varchar(300) NOT NULL,
  `energy_sum` varchar(300) NOT NULL,
  `energy_min` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_theft_detection_type`
--

INSERT INTO `remote_user_theft_detection_type` (`id`, `LCLid`, `Age`, `Sex`, `day`, `energy_median`, `energy_mean`, `energy_max`, `energy_count`, `energy_std`, `energy_sum`, `energy_min`, `Prediction`) VALUES
(1, 'jrcc3ria', '49', 'F', '13-10-19', '0.18', '0.230979167', '0.933', '48', '0.192329006', '11.087', '0.076', 'Theft'),
(2, 't1n4fbsi', '37', 'M', '14-10-19', '0.158', '0.275479167', '1.085', '48', '0.274647239', '13.223', '0.07', 'No Theft'),
(3, 'lv3hdgxa', '48', 'F', '15-10-19', '0.131', '0.2136875', '1.164', '48', '0.224483441', '10.257', '0.07', 'Theft'),
(4, 's9vecqv9', '39', 'M', '17-10-19', '0.148', '0.226770833', '0.784', '48', '0.18440857', '10.885', '0.067', 'No Theft');
