"""electricity_theft_detection URL Configuration
...
from electricity_theft_detection import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Financial_Type/$', remoteuser.Predict_Financial_Type, name="Predict_Financial_Type"),
    ...
    url(r'^View_Financial_Type_Ratio/$', serviceprovider.View_Financial_Type_Ratio, name="View_Financial_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Financial_Type/$', serviceprovider.View_Prediction_Of_Financial_Type, name="View_Prediction_Of_Financial_Type"),
